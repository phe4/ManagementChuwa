...
const ProductDetail = () => {
  ...
  const getProduct = useCallback(async () => {
    try {
      ...
      const cartProduct = cartItems.find((t) => t.product._id === productData._id);
    ...
    <div className="w-full h-full px-5 md:px-16 items-center flex flex-col overflow-y-auto pb-7">
      ...
      </div>
      {
        product
          ?
          <div
            className="w-full bg-white rounded-lg p-5 md:p-10 flex flex-col md:flex-row md:max-w-7xl">
            ...
            <div
              className="w-full h-full flex flex-col justify-center md:justify-start items-left md:items-start md:mx-8 md:pt-5">
